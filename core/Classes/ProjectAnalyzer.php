...
use JD\PhpProjectAnalyzer\Classes\Analyze;
...
class ProjectAnalyzer
{
    ...
    public function __construct($parameters, $labels)
    {
        // qq chemin
        $this->jetonPath = __DIR__.'/../../generated/jetons';
        $this->reportPath = __DIR__.'/../../generated/reports';
...
//        $this->calculateScore();
    ...
    {
        return file_exists($this->jetonPath.'/jetonAnalyse');
    }
    ...
    {
        $file = $this->jetonPath.'/timeAnalyse';
        if (file_exists($file)) {
            $this->oAnalyze
