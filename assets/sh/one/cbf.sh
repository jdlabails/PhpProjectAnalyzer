...
echo "php ${DIR_PHAR}/phpcbf.phar --extensions=php --standard=PSR2 ${DIR_SRC} --no-patch" > ${DIR_REPORT}/CS/cmd.txt
php ${DIR_PHAR}/phpcbf.phar --extensions=php --standard=PSR2 ${DIR_SRC} --no-patch > ${DIR_REPORT}/CS/summary.txt 2>&1
